...
def get_pyqt_values():
    ...
    class InputDialog(QDialog):
        ...
        def initUI(self):
            ...
            self.mem_cb.addItems(['2708', '2716', '2732', '2764', '27128', '27256', '27512'])
...
if len(sys.argv) >= 2:
    ...
    parser.add_argument('-mem', metavar='<type>', type=str, choices=['2708', '2716', '2732', '2764', '27128', '27256', '27512'],
                        default='27512', help='Emulated EPROM memory type, eg.: 2708..27512. Defaults to 27512')
